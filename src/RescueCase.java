public abstract class RescueCase implements RescueOperations {
    ...
    public RescueCase(int rescueID, String animalName, String species, String rescueLocation, String assignedRanger, int numberOfRescueDays, double dailyCareCost, String rescueStatus) {
